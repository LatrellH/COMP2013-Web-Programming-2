 ...
 * and returns a string with the dollar amount as realtor fees using the following conditions,
...
/**
 * Task-6: filter all the listings by builtIn property for all houses built on or after 1990.
 * Name the variable newBuiltListings
 */
//WRITE YOUR CODE BELOW
const newBuiltListings = listings.filter((listing) => {
  const year = parseInt(listing.propertySummary.builtIn);
